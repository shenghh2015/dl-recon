function generate_samplesv3_no_inv_crime(n, output_dirname, H_large,H_small, start_index)
...
%     g_orig = g;
%     noise = poissrnd(lamb);
%     g = g+P_noise*noise - P_noise*mean(noise);
...
% ===== EOF ====== [generate_samplesv3_no_inv_crime.m] ======  
