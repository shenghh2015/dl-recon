...
# v13 -- mass run on chpc -- Mar 7
# Testing size of CNN with adam
# python3 train3_projection_cnn.py --nb_filters=64 --f_dim1 16 --f_dim2 1 --f_dim3 8 --loss mse --batch_size 128 --final_act True --dataset 13 --init_epochs 2000 --inter_epochs 400 --num_loop 0 --lr .01 
# python3 train3_projection_cnn.py --nb_filters=128 --f_dim1 16 --f_dim2 1 --f_dim3 8 --loss mse --batch_size 64 --final_act True --dataset 13 --init_epochs 2000 --inter_epochs 400 --num_loop 0 --lr .01
# python3 train3_projection_cnn.py --nb_filters=256 --f_dim1 16 --f_dim2 1 --f_dim3 8 --loss mse --batch_size 32 --final_act True --dataset 13 --init_epochs 2000 --inter_epochs 400 --num_loop 0 --lr .01 
# python3 train3_projection_cnn.py --nb_filters=128 --f_dim1 16 --f_dim2 1 --f_dim3 8 --loss mse --batch_size 20 --final_act True --dataset 13 --init_epochs 2000 --inter_epochs 400 --num_loop 0 --lr .01  --longer 2
# python3 train3_projection_cnn.py --nb_filters=512 --f_dim1 16 --f_dim2 1 --f_dim3 8 --loss mse --batch_size 16 --final_act True --dataset 13 --init_epochs 2000 --inter_epochs 400 --num_loop 0 --lr .01 
# python3 train3_projection_cnn.py --nb_filters=128 --f_dim1 12 --f_dim2 3 --f_dim3 10 --loss mse --batch_size 16 --final_act True --dataset 13 --init_epochs 2000 --inter_epochs 400 --num_loop 0 --lr .01 
...
for i in range(len(f_dim1)):
    ...
    model.name = 'deartifact_'+str(lrelu[i])+'_'+'{0:.3f}'.format(alpha[i])+ '_' + str(f_dim1[i]) + \
            ...
            '_' + str(args.init_epochs) + '_' + str(args.normalize)+ '_'+ str(args.dropout) + \
