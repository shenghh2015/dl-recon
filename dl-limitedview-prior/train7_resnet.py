...
model = cg.residual_projectionNet(depth=args.depth,nb_filters=args.nb_filters,input_shape=input_shape,dropout=args.dropout)
...
# 	model = make_parallel(model,args.num_gpus)
	print('which_gpu{}, gpu_num{}'.format(args.which_gpu,args.num_gpus))
	model = make_parallel_specify(model,args.num_gpus,0)
